...
export default function HotelariaSolutions() {
  ...
  const useCases = [
    {
      icon: Hotel,
      title: t("hotel.systems.title"),
      description: t("hotel.systems.desc"),
    },
    {
      icon: Database,
      title: t("common.db.label"),
      description: t("hotel.db.desc"),
    },
    {
      icon: Cloud,
      title: t("common.backup.cloud"),
      description: t("hotel.backup.desc"),
    }
  ];
