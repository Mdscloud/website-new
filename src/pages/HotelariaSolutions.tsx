...
import { Shield, Lock, Server, Hotel, CheckCircle2, ArrowRight, Phone, Calendar, Zap, Users, Clock, Settings, Database, Cloud } from "lucide-react";
...
export default function HotelariaSolutions() {
  const benefits = [
    'Sistemas de gestão hoteleira (PMS) sempre disponíveis',
    'Backup automatizado de dados críticos de reservas',
    'Integração com sistemas de pagamento e booking',
    'Alta performance para picos de demanda sazonal',
    'Conformidade com LGPD para dados de hóspedes',
    'Suporte 24x7 para sistemas que não podem parar',
    'Ambientes de contingência para alta temporada',
  ...
  const useCases = [
    {
      icon: Hotel,
      title: 'Sistemas PMS',
      description: 'Ambientes otimizados para sistemas de gestão hoteleira com alta disponibilidade',
    },
    {
      icon: Database,
      title: 'Bancos de Dados',
      description: 'Gestão especializada de bancos de dados para sistemas críticos de reservas',
    },
    {
      icon: Cloud,
      title: 'Backup em Nuvem',
      description: 'Proteção completa de dados de reservas, hóspedes e transações',
    }
  ];
                ...
                >
                  <motion.div variants={fadeInUp}>
                    <Badge className="mb-6 bg-primary text-primary-foreground hover:bg-primary/90 border-0 px-4 py-2">
                      <Hotel className="h-4 w-4 mr-2 inline" />
                  ...
                  >
                    Infraestrutura Cloud para o Setor Hoteleiro
                  </motion.h1>
                  
                  <motion.p variants={fadeInUp} className="text-lg text-muted-foreground mb-8">
                    Soluções especializadas para hotéis, resorts e redes hoteleiras. Infraestrutura de alta performance, disponibilidade 24x7 e suporte especializado para sistemas críticos de gestão hoteleira.
                  </motion.p>
          ...
          <section className="py-20 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  Nossos parceiros do setor Hoteleiro
                </motion.h2>
                <motion.div 
                  variants={fadeInUp}
          ...
          <section className="py-20 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  Infraestrutura otimizada para as necessidades específicas do setor hoteleiro
                </motion.p>
              </motion.div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-display font-bold mb-6 text-foreground">
                  Pronto para transformar a infraestrutura do seu hotel?
                </h2>
                <p className="text-lg text-muted-foreground mb-8">
                  Fale com nossos especialistas e descubra como podemos ajudar sua rede hoteleira a alcançar novos patamares de performance e disponibilidade.
                </p>
